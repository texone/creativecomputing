	...
	private class CCRing{
		...
		public void update(){
			...
			for(double i = 0; i <= res;i++){
				...
				CCRay3 myRay0 = new CCRay3(new CCVector3(0,0,0), new CCVector3(200,y * _myRadius0,z * _myRadius0));
				CCRay3 myRay1 = new CCRay3(new CCVector3(0,0,0), new CCVector3(200,y * myRadius1,z * myRadius1));
		...
		public void draw(CCGraphics g){
			...
			for(int i = 0; i < _myPoints.size();i+=step){
