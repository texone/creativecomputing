...
public class CCGPUBloomDemo extends CCGL2Adapter {
	
	@CCProperty(name = "bloom")
	private CCGPUBloom _myBloom;
	private CCTexture2D _myTexture;

	@Override
	public void init(CCGraphics g, CCAnimator theAnimator) {
		_myTexture = new CCTexture2D(CCImageIO.newImage(CCNIOUtil.dataPath("textures/test1.jpg")));
		_myBloom = new CCGPUBloom(g);
	}
	...
	public static void main(String[] args) {
		CCGPUBloomDemo demo = new CCGPUBloomDemo();
