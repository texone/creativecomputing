...
void main(){
	...
	vec4 color0 = texture2D(textureSampler0, vec2(gl_TexCoord[0].s * 0.5,1 - gl_TexCoord[0].t * 6));
	vec4 color1 = texture2D(textureSampler1, vec2(gl_TexCoord[0].s * 0.5,1 - gl_TexCoord[0].t * 6));
