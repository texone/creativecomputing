...
public class CCParallaxDemo2 extends CCGL2Adapter {
	...
	public void init(CCGraphics g, CCAnimator theAnimator) {
		...
		_myParalaxShader = new CCGLProgram(CCNIOUtil.classPath(this, "paralax_vertex3.glsl"), CCNIOUtil.classPath(this, "paralax_fragment3.glsl"));
	...
	public static void main(String[] args) {
		...
		CCParallaxDemo2 demo = new CCParallaxDemo2();
