...
public class CCNoiseField extends CCGL2Adapter {
	...
	public void init(CCGraphics g, CCAnimator theAnimator) {
		_myProgram = new CCGLProgram(null, CCNIOUtil.classPath(this, "noisefield.glsl"));
	...
	public static void main(String[] args) {
		...
		CCNoiseField demo = new CCNoiseField();
