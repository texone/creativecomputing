...
public class CC02Signal extends CCGL2Adapter {
	...
	public void init(CCGraphics g, CCAnimator theAnimator) {
		...
		_cLineSHader = new CCGLProgram(
			CCNIOUtil.classPath(this, "02signal_vertex.glsl"),
			CCNIOUtil.classPath(this, "02signal_fragment.glsl")
		);
	}
	...
	public static void main(String[] args) {
		...
		CC02Signal demo = new CC02Signal();
