...
public class CCNoiseDemo extends CCGL2Adapter {
	...
	public void init(CCGraphics g, CCAnimator theAnimator) {
		_myProgram = new CCGLProgram(null, CCNIOUtil.classPath(this, "noisecontours.glsl"));
	...
	public static void main(String[] args) {
		...
		CCNoiseDemo demo = new CCNoiseDemo();
