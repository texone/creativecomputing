...
public class GL03HelloShader extends CCGLApp {
	...
	public void setup() {
		...
		// position attribute
	    VAO.attributes(0, 3, GLDataType.FLOAT, false, 6 * 4, 0);
	    VAO.enableVertexAttribArray(0);
	    // color attribute
	    VAO.attributes(1, 3, GLDataType.FLOAT, false, 6 * 4, 3 * 4);
	...
	public void display(CCGraphics g) {
		...
		VAO.drawArrays(GLDrawMode.TRIANGLES, 0, 3);
		shaderProgram.end();
	...
	public static void main(String[] args) {
		GL03HelloShader demo = new GL03HelloShader();
