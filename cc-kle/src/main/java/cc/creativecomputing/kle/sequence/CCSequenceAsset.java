...
public class CCSequenceAsset extends CCAsset<CCSequence>{
	...
	private final CCKleMapping<?> _myMapping;
	
	private String[] _myExtensions;
	
	public CCSequenceAsset(CCKleMapping<?> theMapping, String...theExtensions){
		_myAsset = null;
		_myFrame = null;
	...
	public CCSequence loadAsset(Path thePath){
		CCSequence mySequence = CCKleIO.load(thePath, _myMapping);
