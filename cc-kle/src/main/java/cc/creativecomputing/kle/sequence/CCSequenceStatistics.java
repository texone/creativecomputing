...
import cc.creativecomputing.kle.formats.CCKleBinFormat;
...
public class CCSequenceStatistics {
	...
	public static void main(String[] args) {
		CCKleEffectables myElements = null;//new CCSequenceElements(CCNIOUtil.dataPath("FINALMASTER/out01complete"), 0, 0, 0);
		
		CCSequence mySequence = new CCKleBinFormat().load(CCNIOUtil.dataPath("FINALMASTER/out01complete/raw.bin"), myElements.mappings().get("motors"));
