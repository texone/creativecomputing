...
public class CCKleMapping<ChannelType extends CCKleChannel> extends ArrayList<ChannelType> {
	...
	public CCKleMapping(CCDataElement theMappingXML){
	...
	public CCDataElement toXML(){
		...
		for(CCKleChannel myChannel:this){
