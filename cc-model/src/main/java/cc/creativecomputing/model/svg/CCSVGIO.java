...
public class CCSVGIO {
	...
	class CCSVGGradient extends CCSVGElement {
		...
		CCSVGGradient(CCSVGGroup parent, CCDataObject theSVG) {
			super(parent);
...
//			color = new int[theSVG.countChildren()];
			...
			for (CCDataObject elem:theSVG) {
				if (theSVG.containsKey("stop")) {
	...
	class LinearGradient extends CCSVGGradient {
		...
		public LinearGradient(CCSVGGroup parent, CCDataObject theSVG) {
			super(parent, theSVG);

			this.x1 = getDoubleWithUnit(theSVG, "x1");
			this.y1 = getDoubleWithUnit(theSVG, "y1");
			this.x2 = getDoubleWithUnit(theSVG, "x2");
			this.y2 = getDoubleWithUnit(theSVG, "y2");

			String transformStr = theSVG.getString("gradientTransform");
	...
	class RadialGradient extends CCSVGGradient {
		...
		public RadialGradient(CCSVGGroup parent, CCDataObject theSVG) {
			super(parent, theSVG);

			this.cx = getDoubleWithUnit(theSVG, "cx");
			this.cy = getDoubleWithUnit(theSVG, "cy");
			this.r = getDoubleWithUnit(theSVG, "r");
