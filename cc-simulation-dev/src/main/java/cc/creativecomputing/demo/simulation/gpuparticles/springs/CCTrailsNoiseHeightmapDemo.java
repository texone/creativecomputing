...
//			_myAnchoredSprings.setSpringPos(_myLeadingParticle, new CCVector3f(_myX, 0, _myY));
	...
	private CCNoiseHeightMapForce _myHeightField = new CCNoiseHeightMapForce(0.005f,1,100,new CCVector3f(100,20,30));
	
	private CCGravity _myGravity = new CCGravity(new CCVector3f(1,0,0));
