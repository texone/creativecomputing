...
public abstract class CCTexture{
	...
	public enum CCTextureWrap{
		...
		public static CCTextureWrap byGLID(int theGLID){
			switch(theGLID){
			case GL_CLAMP: return CLAMP;
			case GL_CLAMP_TO_BORDER: return CLAMP_TO_BORDER;
			case GL_CLAMP_TO_EDGE: return CLAMP_TO_EDGE;
			case GL_MIRRORED_REPEAT: return CCTextureWrap.MIRRORED_REPEAT;
			case GL_REPEAT: return CCTextureWrap.REPEAT;
			}
			return null;
		}
	}
	...
	protected CCTextureFilter _myTextureFilter = CCTextureFilter.LINEAR;
	protected CCTextureMipmapFilter _myTextureMipmapFilter = CCTextureMipmapFilter.LINEAR;
...
//		case ETC1_RGB8_OES: return CCPixelInternalFormat.ETC1_RGB8_OES;
	...
	public ByteBuffer dataBuffer(int theLevel) {
		ByteBuffer myBuffer = CCBufferUtil.newDirectByteBuffer(size() * _myPixelType.bytesPerChannel * 4);
		glGetTexImage(_myTarget.glID, theLevel, _myFormat.glID, _myPixelType.glID, myBuffer);
		myBuffer.rewind();
		return myBuffer;
	}
...
//		glDeleteTextures(_myTextureIDs.length, _myTextureIDs, 0);
	...
	public CCTextureWrap wrapR(){
		return CCTextureWrap.byGLID(parameteri(GL_TEXTURE_WRAP_R));
	}
	...
	public CCTextureWrap wrapS(){
		return CCTextureWrap.byGLID(parameteri(GL_TEXTURE_WRAP_S));
	}
	...
	public CCTextureWrap wrapT(){
		return CCTextureWrap.byGLID(parameteri(GL_TEXTURE_WRAP_T));
	}
	...
	public CCTextureFilter textureFilter(){
	...
	public CCTextureMipmapFilter textureMipmapFilter(){
	...
	public CCTextureEnvironmentMode textureEnvironmentMode() {
