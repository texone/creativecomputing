...
public class CCUnicodeBlock {
	...
	/**
	 * Contains all available characters for entypo font used to place small icons with a font.
	 */
	public static final CCUnicodeBlock ENTYPO = new CCUnicodeBlock(
		"ENTYPO",
		CCEntypoIcon.ICON_500PX.id, CCEntypoIcon.ICON_YOUTUBE_WITH_CIRCLE.id
	);
