        ...
        glfwSetKeyCallback(window, (windowHnd, key, scancode, action, mods) -> {
            ...
            switch (key) {
                ...
                case GLFW_KEY_N:
                    ...
                    System.out.println(tinyfd_notifyPopup("Please read...", "...this message.", "warning"));
                    break;
                case GLFW_KEY_1:
                ...
                case GLFW_KEY_3:
                	 try (MemoryStack stack = stackPush()) {
                		 PointerBuffer aFilterPatterns = stack.mallocPointer(0);
...
//                         aFilterPatterns.put(stack.UTF8("*.png"));
                    ...
                    System.out.println(tinyfd_openFileDialog("Open File(s)", "", aFilterPatterns, "Image files (*.jpg, *.png)", true));
                	 }
                    break;
                case GLFW_KEY_4:
                    try (MemoryStack stack = stackPush()) {
