...
public class GLTexture1D extends GLTexture{
	 ...
	 */
	public GLTexture1D(final GLTextureAttributes theTextureAttributes) {
		super(GLTextureTarget.TEXTURE_1D, theTextureAttributes);
	}
	
	public GLTexture1D(CCImage theImage){
		this();
		data(theImage);
	}
