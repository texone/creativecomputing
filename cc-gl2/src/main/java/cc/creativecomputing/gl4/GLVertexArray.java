...
import static org.lwjgl.opengl.GL30.glVertexAttribI1i;
import static org.lwjgl.opengl.GL30.glVertexAttribI2i;
import static org.lwjgl.opengl.GL30.glVertexAttribI3i;
import static org.lwjgl.opengl.GL30.glVertexAttribI4i;
import static org.lwjgl.opengl.GL30.glVertexAttribIPointer;
import static org.lwjgl.opengl.GL31.glDrawArraysInstanced;
import static org.lwjgl.opengl.GL32.glDrawElementsBaseVertex;
import static org.lwjgl.opengl.GL33.glVertexAttribDivisor;
import static org.lwjgl.opengl.GL41.glVertexAttribL1d;
import static org.lwjgl.opengl.GL41.glVertexAttribL2d;
...
public class GLVertexArray {
	...
	public void attributes(int theIndex, int theSize, GLDataType theType, boolean theIsNormalized, int theStride) {
		glVertexAttribPointer(theIndex, theSize, theType.glID(), theIsNormalized, theStride, 0);
	}

	public void attributes(int theIndex, int theSize, GLDataType theType, boolean theIsNormalized, int theStride, long theOffset) {
		glVertexAttribPointer(theIndex, theSize, theType.glID(), theIsNormalized, theStride, theOffset);
	}

	public void attributes(int theIndex, int theSize, int theStride, long theOffset) {
		glVertexAttribPointer(theIndex, theSize, GLDataType.FLOAT.glID(), false, theStride, theOffset);
	}
	...
	public void attributes(int theIndex, int theSize) {
		glVertexAttribPointer(theIndex, theSize, GLDataType.FLOAT.glID(), false, 0, 0);
	}
	...
	public void attributesI(int theIndex, int theSize, GLDataType theType, int theStride) {
		glVertexAttribIPointer(theIndex, theSize, theType.glID(), theStride, 0);
	}
	...
	public void attributeDivisor(int theIndex, int theDivisor) {
		glVertexAttribDivisor(theIndex, theDivisor);
	}
	...
	public void drawArrays(GLDrawMode theDrawMode, int theFirst, int theCount) {
		glDrawArrays(theDrawMode.glID(), theFirst, theCount);
	}
	
	// TODO add documentation
	public void drawArraysInstanced(GLDrawMode theDrawMode, int theFirst, int theCount, int thePrimitivCount){
		glDrawArraysInstanced(GL_TRIANGLES, theFirst, theCount, thePrimitivCount);
	}
	...
	public void drawElements(GLDrawMode theDrawMode, int theCount, GLDataType theType) {
		glDrawElements(theDrawMode.glID(), theCount, theType.glID(), 0);
	}
	...
	public void drawElements(GLDrawMode theDrawMode, int theCount, GLDataType theType, int theBaseVertex) {
		glDrawElementsBaseVertex(theDrawMode.glID(), theCount, theType.glID(), 0, theBaseVertex);
	}
	 ...
	 */
	public void multiDrawArrays(GLDrawMode theDrawMode, IntBuffer theFirst, IntBuffer theCount) {
		glMultiDrawArrays(theDrawMode.glID(), theFirst, theCount);
	}
	 ...
	 *            stored.
	 */
	public void multiDrawElements(GLDrawMode theDrawMode, IntBuffer theCount, GLDataType theType, PointerBuffer theIndices) {
		glMultiDrawElements(theDrawMode.glID(), theCount, theType.glID(), theIndices);
	}

	@Override
	protected void finalize() {
		glDeleteVertexArrays(_myID);
	}
