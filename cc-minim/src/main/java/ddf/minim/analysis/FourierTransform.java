...
public abstract class FourierTransform {
	 ...
	 * 
	 * @param minBandwidth int: the minimum bandwidth used for an octave, in
	 *            Hertz.
	 ...
	 * 
	 * @param windowFunction the new WindowFunction to use, typically one of the
	 *            statically defined windows like HAMMING or BLACKMAN
	 * 
	 * @related FFT
	 ...
	 * 
	 * @param averageIndex int: the index of the average you want the bandwidth
	 *            of
	 * 
	 ...
	 * <code>inverse()</code>.
	 * 
	 * @param i int: the frequency band to modify
	 ...
	 * 
	 * @param buffer float[]: the buffer to analyze, must be the same length as
	 *            timeSize()
	 * 
	 * @example Basics/AnalyzeSound
	 * 
	 ...
	 * @param buffer float[]: the buffer to analyze, must be the same length as
	 *            timeSize()
	 * @param startAt int: the index to start at in the buffer. there must be at
	 ...
	 * 
	 */
	public void forward(CCAudioBuffer buffer, int startAt) {
	 ...
	 * 
	 * @param buffer float[]: the buffer to place the result of the inverse
	 *            transform in
	 * 
	 ...
	 * result in <code>buffer</code>.
	 * 
	 * @param buffer AudioBuffer: the buffer to place the result of the inverse
	 *            transform in
	 * 
	 * @example Analysis/FFT/Inverse_Transform
	 */
	 ...
	 * 
	 * @param freqReal float[]: the real part of the frequency spectrum
	 * @param freqImag float[]: the imaginary part the frequency spectrum
	 * @param buffer float[]: the buffer to place the inverse transform in
	 */
