...
/**
 * <code>AudioBuffer</code> encapsulates a sample buffer of floats. All Minim
 * classes that give you access to audio samples do so with an
 * <code>AudioBuffer</code>. The underlying array is not immutable and this
...
public final class CCAudioBuffer {
	private float[] samples;

	/**
	 * Constructs and AudioBuffer that is <code>bufferSize</code> samples long.
	 * 
	 * @param bufferSize the size of the buffer
	 */
	CCAudioBuffer(int bufferSize) {
	 ...
	 * will be reported and nothing will be done. The mixing function is:
	 * <p>
