...
public class CCPointGridDemo extends CCGL4Adapter{
	...
	public void start(CCAnimator theAnimator) {
		_myPrimitive = new CCPointGrid(-0.5f, -0.5f, 1f, 1f, 10, 10);
	}
...
//	    myEffect.wireState().lineWidth = 10;
	...
	public static void main(String[] args) {
		CCGL4Application myAppManager = new CCGL4Application(new CCPointGridDemo());
