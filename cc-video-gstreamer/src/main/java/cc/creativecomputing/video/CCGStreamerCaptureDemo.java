...
public class CCGStreamerCaptureDemo extends CCGL2Adapter {
	
	private Capture _myData;
...
//		_myData = new CCGStreamerMovie(this, CCIOUtil.dataPath("videos/120116_spline2_fine2_1356x136_jpg.mov"));
		_myData = new Capture(theAnimator);//
		_myData.start();
...
//		}
	...
	public static void main(String[] args) {
		CCGStreamerCaptureDemo demo = new CCGStreamerCaptureDemo();
