...
/**
 * This class loads the gstreamer native libraries. By Andres Colubri Based on
 * code by Tal Shalif
 * 
 */
public class LibraryLoader {
	...
	static final Object[][] WINDOWS_DEPENDENCIES = {
			...
			// External libraries
			{ "liba52-0", new String[] {}, false }, { "libass-5", new String[] {}, false },
			{ "libbz2", new String[] {}, false }, { "libcairo-2", new String[] {}, false },
			{ "libcairo-gobject-2", new String[] {}, false },
			{ "libcairo-script-interpreter-2", new String[] {}, false }, { "libcharset-1", new String[] {}, false },
			{ "libcroco-0.6-3", new String[] {}, false }, { "libdca-0", new String[] {}, false },
			{ "libdv-4", new String[] {}, false }, { "libdvdnav-4", new String[] {}, false },
			{ "libdvdread-4", new String[] {}, false }, { "libexpat-1", new String[] {}, false },
			{ "libfaad-2", new String[] {}, false }, { "libffi-7", new String[] {}, false },
			{ "libFLAC-8", new String[] {}, false }, { "libfontconfig-1", new String[] {}, false },
			{ "libfreetype-6", new String[] {}, false }, { "libfribidi-0", new String[] {}, false },
			{ "libgcc_s_sjlj-1", new String[] {}, false }, { "libgdk_pixbuf-2.0-0", new String[] {}, false },
			{ "libges-1.0-0", new String[] {}, false }, { "libgio-2.0-0", new String[] {}, false },
			{ "libglib-2.0-0", new String[] {}, false }, { "libgmodule-2.0-0", new String[] {}, false },
			{ "libgmp-10", new String[] {}, false }, { "libgnutls-30", new String[] {}, false },
			{ "libgnutlsxx-28", new String[] {}, false }, { "libgobject-2.0-0", new String[] {}, false },
			{ "libgomp-1", new String[] {}, false }, { "libgraphene-1.0-0", new String[] {}, false },
			{ "libgthread-2.0-0", new String[] {}, false }, { "libharfbuzz-0", new String[] {}, false },
			{ "libhogweed-4", new String[] {}, false }, { "libiconv-2", new String[] {}, false },
			{ "libintl-8", new String[] {}, false }, { "libjpeg-8", new String[] {}, false },
			{ "libjson-glib-1.0-0", new String[] {}, false }, { "libkate-1", new String[] {}, false },
			{ "libmms-0", new String[] {}, false }, { "libmp3lame-0", new String[] {}, false },
			{ "libmpeg2-0", new String[] {}, false }, { "libmpeg2convert-0", new String[] {}, false },
			{ "libmpg123-0", new String[] {}, false }, { "libnettle-6", new String[] {}, false },
			{ "libnice-10", new String[] {}, false }, { "libogg-0", new String[] {}, false },
			{ "liboggkate-1", new String[] {}, false }, { "libopencore-amrnb-0", new String[] {}, false },
			{ "libopencore-amrwb-0", new String[] {}, false }, { "libopenh264", new String[] {}, false },
			{ "libopenjp2", new String[] {}, false }, { "libopus-0", new String[] {}, false },
			{ "liborc-0.4-0", new String[] {}, false }, { "liborc-test-0.4-0", new String[] {}, false },
			{ "libpango-1.0-0", new String[] {}, false }, { "libpangocairo-1.0-0", new String[] {}, false },
			{ "libpangoft2-1.0-0", new String[] {}, false }, { "libpangowin32-1.0-0", new String[] {}, false },
			{ "libpixman-1-0", new String[] {}, false }, { "libpng16-16", new String[] {}, false },
			{ "librsvg-2-2", new String[] {}, false }, { "librtmp-1", new String[] {}, false },
			{ "libsbc-1", new String[] {}, false }, { "libSoundTouch-1", new String[] {}, false },
			{ "libsoup-2.4-1", new String[] {}, false }, { "libspandsp-2", new String[] {}, false },
			{ "libspeex-1", new String[] {}, false }, { "libsrtp", new String[] {}, false },
			{ "libstdc++-6", new String[] {}, false }, { "libtag", new String[] {}, false },
			{ "libtasn1-6", new String[] {}, false }, { "libtheora-0", new String[] {}, false },
			{ "libtheoradec-1", new String[] {}, false }, { "libtheoraenc-1", new String[] {}, false },
			{ "libtiff-5", new String[] {}, false }, { "libturbojpeg-0", new String[] {}, false },
			{ "libvisual-0.4-0", new String[] {}, false }, { "libvo-aacenc-0", new String[] {}, false },
			{ "libvorbis-0", new String[] {}, false }, { "libvorbisenc-2", new String[] {}, false },
			{ "libvorbisfile-3", new String[] {}, false }, { "libwavpack-1", new String[] {}, false },
			{ "libwinpthread-1", new String[] {}, false }, { "libx264-148", new String[] {}, false },
			{ "libxml2-2", new String[] {}, false }, { "libz", new String[] {}, false } };

	static final Object[][] MACOSX_DEPENDENCIES = { { "gstbase-1.0", new String[] { "gstreamer-1.0" }, true },
	...
	static final Object[][] DEFAULT_DEPENDENCIES = { { "gstreamer-1.0", new String[] {}, true },
