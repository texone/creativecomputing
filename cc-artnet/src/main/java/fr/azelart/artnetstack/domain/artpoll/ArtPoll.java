...
public class ArtPoll extends ArtNetObject {
	 ...
	 */
	public final void setArtPollReplyWhenConditionsChanges(final Boolean artPollReplyWhenConditionsChanges) {
	 ...
	 */
	public final void setNetworkCommunicationTypeDiagnosticsMessages(final NetworkCommunicationTypeEnum networkCommunicationTypeDiagnosticsMessages) {
