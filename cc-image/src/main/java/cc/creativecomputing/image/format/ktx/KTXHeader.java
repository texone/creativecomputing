...
public class KTXHeader {
	...
	public String toString() {
		return String.format("%s[glType=%d, glTypeSize=%d, glFormat=%d, glInternalFormat=%d, "
				...
				+ "numberOfArrayElements=%d, numberOfFaces=%d, numberOfMipmapLevels=%d, " + "bytesOfKeyValueData=%d]", getClass()
				.getSimpleName(), glType, glTypeSize, glFormat, glInternalFormat, glBaseInternalFormat, pixelWidth, pixelHeight,
				pixelDepth, numberOfArrayElements, numberOfFaces, numberOfMipmapLevels, bytesOfKeyValueData);
	}
