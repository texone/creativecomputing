...
public class Demo07FragColorFromPos extends CCGL4Adapter{
	...
	public void init(GLGraphics g) {
		_myShader = new GLShaderProgram(
			new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "Demo07FragColorFromPos_vert.glsl")),
			new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "Demo07FragColorFromPos_frag.glsl"))
		);
	...
	public static void main(String[] args) {
		...
		CCGL4Application myAppManager = new CCGL4Application(new Demo07FragColorFromPos());
		
		myAppManager.animator().framerate = 30;
		myAppManager.animator().animationMode = CCAnimationMode.FRAMERATE_PRECISE;
		
		myAppManager.glcontext().title = "OpenGL SuperBible - FragColor from Position";
