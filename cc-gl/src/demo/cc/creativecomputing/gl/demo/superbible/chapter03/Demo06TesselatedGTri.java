...
public class Demo06TesselatedGTri extends CCGL4Adapter{
	...
	public void init(GLGraphics g) {
		_myShader = new GLShaderProgram(
			new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "Demo05TesselatedTri_vert.glsl")),
			new GLShaderObject(GLShaderType.TESS_CONTROL, CCNIOUtil.classPath(this, "Demo05TesselatedTri_tcs.glsl")),
			new GLShaderObject(GLShaderType.TESS_EVALUATION, CCNIOUtil.classPath(this, "Demo05TesselatedTri_tes.glsl")),
			new GLShaderObject(GLShaderType.GEOMETRY, CCNIOUtil.classPath(this, "Demo06TesselatedGTri_gs.glsl")),
			new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "Demo05TesselatedTri_frag.glsl"))
		);
	...
	public void display(GLGraphics g) {
        ...
        _myShader.use();
        _myVertexArray.bind();
        _myVertexArray.drawArrays(GLDrawMode.PATCHES, 0, 3);
	}

	public static void main(String[] args) {
		
		CCGL4Application myAppManager = new CCGL4Application(new Demo06TesselatedGTri());
