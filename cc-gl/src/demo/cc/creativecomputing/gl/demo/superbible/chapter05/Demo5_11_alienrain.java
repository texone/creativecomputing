...
public class Demo5_11_alienrain extends CCGL4Adapter{
	...
	public void init(GLGraphics g) {
		_myShader = new GLShaderProgram(
			new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "Demo03SingleTri_vert.glsl")),
			new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "Demo03SingleTri_frag.glsl"))
		);
	...
	public static void main(String[] args) {
		...
		CCGL4Application myAppManager = new CCGL4Application(new Demo5_11_alienrain());
		
		myAppManager.animator().framerate = 30;
		myAppManager.animator().animationMode = CCAnimationMode.FRAMERATE_PRECISE;
		
		myAppManager.glcontext().title = "OpenGL SuperBible - Alien Rain";
