...
public class Demo03SingleTri extends CCGL4Adapter{
	...
	public static void main(String[] args) {
		...
		CCGL4Application myAppManager = new CCGL4Application(new Demo03SingleTri());
		
		myAppManager.animator().framerate = 30;
		myAppManager.animator().animationMode = CCAnimationMode.FRAMERATE_PRECISE;
		
		myAppManager.glcontext().title = "OpenGL SuperBible - Single Triangle";
