...
public class Demo09Flat extends CCGL4Adapter{
	...
	public void init(GLGraphics g) {
	    ...
	    _myShader = new GLShaderProgram(
	    	new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "shader/flat_vert.glsl")),
	    	new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "shader/flat_frag.glsl"))
		);
	    _myShader.use();
	...
	public static void main(String[] args) {
		CCGL4Application myAppManager = new CCGL4Application(new Demo09Flat());
