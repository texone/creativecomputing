...
public class Demo06ADS extends CCGL4Adapter{
	...
	public void init(GLGraphics g) {
	    ...
	    _myShader = new GLShaderProgram(
	    	new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "shader/phong_vert.glsl")),
	    	new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "shader/phong_frag.glsl"))
		);
	    _myShader.use();
	...
	public void update(CCAnimator theAnimator) {
		...
		_myModelMatrix.applyRotationY(myAngle);
	...
	public static void main(String[] args) {
		CCGL4Application myAppManager = new CCGL4Application(new Demo06ADS());
