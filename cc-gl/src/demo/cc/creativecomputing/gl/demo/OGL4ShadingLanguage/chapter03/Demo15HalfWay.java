...
public class Demo15HalfWay extends CCGL4Adapter{
...
//	private CCMesh _myPlane;
	...
	public void init(GLGraphics theG) {
		...
		_myShader = new GLShaderProgram(
			new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "shader/halfway_vert.glsl")),
			new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "shader/halfway_frag.glsl"))
		);
		_myShader.use();
...
//		_myPlane.draw();
	...
	public static void main(String[] args) {
		CCGL4Application myAppManager = new CCGL4Application(new Demo15HalfWay());
