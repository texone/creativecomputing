...
public class Demo21AlphaTexture extends CCGL4Adapter{
...
//	    _myPlane = new CCMesh(new CCGridXZ(10.0f, 10.0f, true).generateMesh(100, 100));
	    ...
	    _myShader = new GLShaderProgram(
	    	new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "shader/alphatest_vert.glsl")),
	    	new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "shader/alphatest_frag.glsl"))
		);
	    _myShader.use();
	    ...
	    _myShader.uniform1i("AlphaTex", 1);
...
//	    _myPlane.draw();
	...
	public static void main(String[] args) {
		CCGL4Application myAppManager = new CCGL4Application(new Demo21AlphaTexture());
