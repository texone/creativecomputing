...
public class Demo01Basic extends CCGL4Adapter{
	...
	public void init(GLGraphics g) {
		_myShader = new GLShaderProgram(
			new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "shader/basic_vert.glsl")),
			new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "shader/basic_frag.glsl"))
		);
		...
		myVertexBuffer.bind();
		_myVertexArray.attributes(_myShader.attribLocation("VertexPosition"), 3);
		
		myColorBuffer.bind();
		_myVertexArray.attributes(_myShader.attribLocation("VertexColor"), 3);
	...
	public static void main(String[] args) {
		CCGL4Application myAppManager = new CCGL4Application(new Demo01Basic());
