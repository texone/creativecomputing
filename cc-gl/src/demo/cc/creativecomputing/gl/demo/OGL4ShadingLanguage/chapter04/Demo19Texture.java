...
public class Demo19Texture extends CCGL4Adapter{
...
//	private CCMesh _myPlane;
	...
	public void init(GLGraphics g) {
		...
		_myTexture = new GLTexture2D(myImage);
...
//	    _myPlane = new CCMesh(new CCGridXZ(10.0f, 10.0f, true).generateMesh(100, 100));
	    ...
	    _myShader = new GLShaderProgram(
	    	new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "shader/texture_vert.glsl")),
	    	new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "shader/texture_frag.glsl"))
		);
	    _myShader.use();
...
//	    _myPlane.draw();
	...
	public static void main(String[] args) {
		CCGL4Application myAppManager = new CCGL4Application(new Demo19Texture());
