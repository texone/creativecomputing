...
public class Demo11Discard extends CCGL4Adapter{
	...
	public void init(GLGraphics theG) {
	    ...
	    _myViewMatrix = CCMatrix4x4.createLookAt(new CCVector3(0.0f,0.0f,7.0f), new CCVector3(0.0f,0.0f,0.0f), new CCVector3(0.0f,1.0f,0.0f));
		...
		_myShader = new GLShaderProgram(
			new GLShaderObject(GLShaderType.VERTEX, CCNIOUtil.classPath(this, "shader/discard_vert.glsl")),
			new GLShaderObject(GLShaderType.FRAGMENT, CCNIOUtil.classPath(this, "shader/discard_frag.glsl"))
		);
		_myShader.use();
	...
	public static void main(String[] args) {
		...
		CCGL4Application myAppManager = new CCGL4Application(new Demo11Discard());
		myAppManager.animator().framerate = 30;
		myAppManager.animator().animationMode = CCAnimationMode.FRAMERATE_PRECISE;
		
		myAppManager.glcontext().size(800, 600);
		myAppManager.start();
	}
}
