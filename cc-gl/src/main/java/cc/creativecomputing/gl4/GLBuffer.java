...
public class GLBuffer {
	...
	public void bind(){
		GL4 gl = GLGraphics.currentGL();
		gl.glBindBuffer(_myTarget.glID, _myID);
	}
	
	public void unbind(){
		GL4 gl = GLGraphics.currentGL();
		gl.glBindBuffer(_myTarget.glID, 0);
	}
	...
	public void allocate(
		...
		GL4 gl = GLGraphics.currentGL();
	    gl.glBufferData(GL.GL_ARRAY_BUFFER, theBytes, null, getAcessFrequencyNature(theAccessFrequency, theAccessNature));
	}
	...
	private int getAcessFrequencyNature(GLDataAccesFrequency theAccessFrequency, GLDataAccesNature theAccessNature){
		...
		case DYNAMIC:
			...
			case COPY: return GL4.GL_DYNAMIC_COPY;
			case DRAW: return GL4.GL_DYNAMIC_DRAW;
			case READ: return GL4.GL_DYNAMIC_READ;
			}
		case STATIC:
			switch(theAccessNature){
			case COPY: return GL4.GL_STATIC_COPY;
			case DRAW: return GL4.GL_STATIC_DRAW;
			case READ: return GL4.GL_STATIC_READ;
			}
		case STREAM:
			switch(theAccessNature){
			case COPY: return GL4.GL_STREAM_COPY;
			case DRAW: return GL4.GL_STREAM_DRAW;
			case READ: return GL4.GL_STREAM_READ;
			}
		}
		return 0;
	}
	...
	public void data(
		...
		GL4 gl = GLGraphics.currentGL();
		gl.glBufferData(_myTarget.glID, theSize, theData, getAcessFrequencyNature(theAccessFrequency, theAccessNature));
		_mySize = theSize;
	}
	...
	public void data(
		...
		data(theData.limit(), theData, theAccessFrequency, theAccessNature);
	}
	...
	public void data(
		...
		data(theSize, theData, GLDataAccesFrequency.STATIC, GLDataAccesNature.DRAW);
	}
	
	public void data(Buffer theData){
		data(theData.limit() * GLBufferUtil.typeSize(theData) * 100, theData, GLDataAccesFrequency.STATIC, GLDataAccesNature.DRAW);
	}
	
	public void datavs(short...theData){
		data(
			GLBufferUtil.sizeof(theData), 
			GLBufferUtil.asBuffer(theData), 
	...
	public void datavf(float...theData){
		data(
			GLBufferUtil.sizeof(theData), 
			GLBufferUtil.asBuffer(theData), 
			GLDataAccesFrequency.STATIC, 
	...
	public void clear(float theValue0, float theValue1, float theValue2, float theValue3){
		bind();
		GL4 gl = GLGraphics.currentGL();
//		gl.glClearBufferData(_myTarget.glID, arg1, arg2, arg3, arg4);
	}
...
//		unbind();
	 ...
	 */
	public static final int MAP_READ_BIT = GL4.GL_MAP_READ_BIT;
	 ...
	 * but the result is undefined and system errors (possibly including program termination) may occur.
	 */
	public static final int MAP_WRITE_BIT = GL4.GL_MAP_WRITE_BIT;
	 ...
	 */
	public static final int MAP_INVALIDATE_RANGE_BIT = GL4.GL_MAP_INVALIDATE_RANGE_BIT;
	 ...
	 */
	public static final int MAP_INVALIDATE_BUFFER_BIT = GL4.GL_MAP_INVALIDATE_BUFFER_BIT;
	 ...
	 */
	public static final int MAP_FLUSH_EXPLICIT_BIT = GL4.GL_MAP_FLUSH_EXPLICIT_BIT;
	 ...
	 */
	public static final int MAP_UNSYNCHRONIZED_BIT = GL4.GL_MAP_UNSYNCHRONIZED_BIT;
...
//		unbind();
	...
	public void flushMappedRange(int theOffset, int theLength){
		bind();
		GL4 gl = GLGraphics.currentGL();
		gl.glFlushMappedBufferRange(_myTarget.glID, theOffset, theLength);
	}
	
	// TODO add documentation
	public void invalidateData(){
		GLGraphics.currentGL().glInvalidateBufferData(_myID);
	}
	
	// TODO add documentation
	public void invalidateSubData(int theOffset, int theLength){
		GLGraphics.currentGL().glInvalidateBufferSubData(_myID, theOffset, theLength);
	}
