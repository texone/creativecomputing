...
public abstract class SwingAbstractTrackDataView<ControllerType extends CCTrackController> extends JPanel {
    ...
    public SwingAbstractTrackDataView(
    	TimelineController theTimelineController, 
    	ControllerType theTrackController
    ) {
...
//        setBorder(BorderFactory.createLineBorder(Color.gray));
    ...
    public void showPopUp(MouseEvent theEvent){
		_myToolChooserPopup.show(SwingAbstractTrackDataView.this, theEvent.getX(), theEvent.getY());
    }
