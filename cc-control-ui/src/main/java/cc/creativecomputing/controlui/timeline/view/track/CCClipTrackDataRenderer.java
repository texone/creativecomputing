...
public class CCClipTrackDataRenderer extends CCTrackDataRenderer{
	...
	private void drawCurvePiece(CCCurveTrackController theController, CCAbstractTrackDataView<?> theView, CCControlPoint myFirstPoint, CCControlPoint mySecondPoint, List<CCVector2> thePath, double theStartTime, double theEndTime) {
...
//        }
	...
	private void drawCurve(CCCurveTrackController _myController, CCAbstractTrackDataView<?> theView, CCGraphics g, CCEventPoint theEvent) {
