 ...
 *
 */
public class CCRemoveControlPointCommand extends CCTrackEditCommand{
	
	public CCRemoveControlPointCommand(CCTrackData theTrackData, List<CCControlPoint> theControlPoints) {
		super(theTrackData, theControlPoints);
	}
	
	public CCRemoveControlPointCommand(CCTrackData theTrackData, CCControlPoint...theControlPoints){
		super(theTrackData, theControlPoints);
	}
