...
public class CCSpringDebugRenderer extends CCParticleRenderer{
	...
	public CCSpringDebugRenderer(CCSpringForce theSprings){
		super("spring debug");
		_myShader = new CCGLProgram(
			CCNIOUtil.classPath(CCSpringDebugRenderer.class, "spring_debug_vertex.glsl"),
			CCNIOUtil.classPath(CCSpringDebugRenderer.class, "spring_debug_fragment.glsl")
		);
