...
public class CCPointSpriteRenderer extends CCParticleRenderer{
	...
	public CCPointSpriteRenderer(
		CCTexture2D thePointSpriteTexture, 
		Path theVertexPath,
	...
	public CCPointSpriteRenderer(CCTexture2D thePointSpriteTexture, int theXSplits, int theYSplits) {
		this(
			thePointSpriteTexture, 
			CCNIOUtil.classPath(CCPointSpriteRenderer.class,"pointsprite_vertex.glsl"), 
			CCNIOUtil.classPath(CCPointSpriteRenderer.class,"pointsprite_fragment.glsl"),
			theXSplits,
			theYSplits
		);
	}
	...
	public void display(CCGraphics g){
		...
		if(_myPointSpriteTexture != null)g.texture(2, _myPointSpriteTexture);
