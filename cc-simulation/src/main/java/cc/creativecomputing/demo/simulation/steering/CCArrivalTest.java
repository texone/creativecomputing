...
public class CCArrivalTest extends CCApp{
	...
	private static class Settings{
		@CCControl (name = "slowing distance", min = 0.1f, max = 500f)
	...
	public void setup(){
		...
		_myArrive = new CCArrive(new CCVector3f(),100);
		...
		_myUI.addControls("behavior", new Settings());
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCArrivalTest.class);
