...
public class CCTestAgent extends CCAgent {
	...
	private CCAABB _myBoundingBox = new CCAABB(new CCVector3(), new CCVector3(scale, scale, scale).multiplyLocal(0.5f));
...
//	}
	...
	public void draw(List<CCVector3> theVertexList) {
		CCVector3 lv0 = globalizePosition(new CCVector3(0.0F, 0.0F, front * scale));
		CCVector3 lv1 = globalizePosition(new CCVector3(0.0F, height * scale, back * scale));
		CCVector3 lv2 = globalizePosition(new CCVector3(-width * scale, 0.0F, back * scale));
		CCVector3 lv3 = globalizePosition(new CCVector3(width * scale, 0.0F, back * scale));
